...
const en = {
  ...
  jobApprovedStartWorkSubtitle: "The estimate has been approved. You can begin the repair.",
...
const ar: typeof en = {
  ...
  jobApprovedStartWorkSubtitle: "تمت الموافقة على التقدير. يمكنك البدء بالإصلاح.",
