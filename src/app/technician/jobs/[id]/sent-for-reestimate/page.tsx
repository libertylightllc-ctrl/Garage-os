...
/**
  * Confirmation screen after the tech taps 'Send for Re-estimate'. Mirrors
  * the existing handoff pages so every workflow handoff has the same
  * explicit"this stage is done"surface.
  */
export default async function SentForReestimate({
  params,
}: {
